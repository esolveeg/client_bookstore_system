...
import { employeesQuery, meQuery } from "@/graphql/queries/queries.js";
...
export default {
  data() {
    let columns = [
      ...
      { label: "salary", name: "salary", dbname: "salary" },
  ...
  apollo: {
    me: {
      ...
      result({ data: { me } }) {
        ...
        permissions.includes("create_employees") ? (this.canAdd = true) : "";
        permissions.includes("delete_employees") ? (this.canDelete = true) : "";
        permissions.includes("edit_employees") ? (this.canEdit = true) : "";
        permissions.includes("read_employees") ? (this.canView = true) : "";
      }
    },
  ...
  methods: {
    ...
    create() {
      this.$router.push({ name: "employees.create" });
    },
    goToView(id) {
      this.$router.push({
        name: "employees.view",
