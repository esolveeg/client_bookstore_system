              ...
              <div class="card-content">
                <form @submit.prevent="submitted()">
                  ...
                  <div class="row">
                    <div
                      class="input-field col s12"
                      :class="{ error: validation.hasError('intersts') }"
                    >
                      <textarea
                        v-model="intersts"
                        id="intersts"
                      ...
                      ></textarea>
                      <label for="intersts" :class="intersts ? 'active' : ''">{{
                        $t("intersts")
                      }}</label>
                      <div class="message">
                        {{ validation.firstError("intersts") }}
                      </div>
                    </div>
                  </div>
...
<script>
import CustomersMixin from "@/mixins/EditAddCustomersMixin.js";

export default {
  name: "edit-add-Customers",
