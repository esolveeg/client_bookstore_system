                ...
                <form @submit.prevent="submitted()">
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      <label for="phone" :class="phone ? 'active' : ''">{{
                        $t("phone")
                      }}</label>
                      <div class="message">
                  ...
                  <div class="row">
                    <div
                      class="input-field col s12"
                      :class="{ error: validation.hasError('salary') }"
                    >
                      <input v-model="salary" id="salary" type="text" />
                      <label for="salary" :class="salary ? 'active' : ''">{{
                        $t("salary")
                      }}</label>
                      <div class="message">
                        {{ validation.firstError("salary") }}
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div
                      class="input-field col s12"
                      :class="{ error: validation.hasError('target') }"
                    >
                      <input v-model="target" id="target" type="text" />
                      <label for="target" :class="target ? 'active' : ''">{{
                        $t("target")
                      }}</label>
                      <div class="message">
                  ...
                  <div class="row">
                    ...
                    >
                      ...
                      <label for="branch" :class="branchs ? 'active' : ''">{{
                        $t("branches")
                      }}</label>
                      <div class="message">
...
<script>
import EmployeesMixin from "@/mixins/EditAddEmployeesMixin.js";

export default {
  name: "edit-add-Employees",
